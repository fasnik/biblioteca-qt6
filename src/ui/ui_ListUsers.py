...
################################################################################
## Form generated from reading UI file 'ListUsersWuVFUg.ui'
##
...
class Ui_ListUsers(object):
    def setupUi(self, ListUsers):
        if not ListUsers.objectName():
            ListUsers.setObjectName(u"ListUsers")
        ListUsers.resize(561, 371)
        ListUsers.setAutoFillBackground(False)
        ListUsers.setLocale(QLocale(QLocale.Portuguese, QLocale.Brazil))
        self.centralWidget = QWidget(ListUsers)
    ...
    def retranslateUi(self, ListUsers):
        ListUsers.setWindowTitle(QCoreApplication.translate("ListUsers", u"Usu\u00e1rios", None))
        self.busca.setPlaceholderText(QCoreApplication.translate("ListUsers", u"Buscar", None))
        self.pesquisar.setText(QCoreApplication.translate("ListUsers", u"Pesquisar", None))
    # retranslateUi
