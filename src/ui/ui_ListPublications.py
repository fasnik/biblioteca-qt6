...
################################################################################
## Form generated from reading UI file 'ListPublicationsZjPfvW.ui'
##
...
class Ui_ListPublications(object):
    def setupUi(self, ListPublications):
        if not ListPublications.objectName():
            ListPublications.setObjectName(u"ListPublications")
        ListPublications.resize(561, 371)
        ListPublications.setAutoFillBackground(False)
        ListPublications.setLocale(QLocale(QLocale.Portuguese, QLocale.Brazil))
        self.centralWidget = QWidget(ListPublications)
        ...
        self.mainWidget.setSelectionBehavior(QAbstractItemView.SelectionBehavior.SelectItems)
        ...
        self.retranslateUi(ListPublications)
        self.busca.returnPressed.connect(self.pesquisar.click)

        self.pesquisar.setDefault(False)


        QMetaObject.connectSlotsByName(ListPublications)
    # setupUi

    def retranslateUi(self, ListPublications):
        ListPublications.setWindowTitle(QCoreApplication.translate("ListPublications", u"Publica\u00e7\u00f5es", None))
        self.busca.setPlaceholderText(QCoreApplication.translate("ListPublications", u"Buscar", None))
        self.pesquisar.setText(QCoreApplication.translate("ListPublications", u"Pesquisar", None))
    # retranslateUi
